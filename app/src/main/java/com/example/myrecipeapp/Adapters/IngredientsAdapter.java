...
import com.example.myrecipeapp.Models.ExtendedIngredient;
...
public class IngredientsAdapter extends RecyclerView.Adapter<IngredientsViewHolder>{
    ...
    public void onBindViewHolder(@NonNull IngredientsViewHolder holder, int position) {
        ...
        holder.textView_ingredients_quality.setText(list.get(position).original);
        holder.textView_ingredients_quality.setSelected(true);
...
class IngredientsViewHolder extends RecyclerView.ViewHolder{
    TextView textView_ingredients_quality,textView_ingredients_name;
    ImageView imageView_ingredients;


    public IngredientsViewHolder(@NonNull View itemView) {
        super(itemView);
        textView_ingredients_quality=itemView.findViewById(R.id.textView_ingredients_quality);
